        ...
        compress: function () {
            ...
            switch (this.type) {
                ...
                case 'gcc':
                    ...
                    command = 'java -jar "' + __dirname + '/google_closure_compiler-v20130411.jar" --angular_pass --compilation_level WHITESPACE_ONLY ' + fileInCommand.join(' ') + ' --language_in=' + (this.language || 'ECMASCRIPT3') + ' --js_output_file="' + this.fileOut + '" ' + this.options.join(' ');
                    break;
                case 'uglifyjs':
